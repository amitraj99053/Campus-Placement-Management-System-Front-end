            ...
            <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 p-8 md:p-12 rounded-3xl text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="grid md:grid-cols-3 gap-8 relative z-10">
                    ...
                    <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 hover:bg-white/15 transition duration-300">
                        ...
                        <div className="space-y-3">
                            <a href="https://www.interviewbit.com/technical-interview-questions/#programming-language-tools-technologies" target="_blank" rel="noopener noreferrer" className="group flex items-start gap-3 p-3 rounded-xl hover:bg-white/10 transition">
                                ...
                                <div>
                                    <p className="font-semibold text-sm text-indigo-50 group-hover:text-white">Must to know</p>
                    ...
                    <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 hover:bg-white/15 transition duration-300">
                        ...
                        <div className="space-y-3">
                            <a href="https://www.interviewbit.com/hr-interview-questions/" target="_blank" rel="noopener noreferrer" className="group flex items-start gap-3 p-3 rounded-xl hover:bg-white/10 transition">
                                <MessageSquare size={18} className="text-purple-300 mt-0.5 group-hover:text-purple-200" />
                                <div>
                                    <p className="font-semibold text-sm text-purple-50 group-hover:text-white">Must to know</p>
                                    <p className="text-xs text-purple-300/80 mt-0.5">Top HR interview questions.</p>
                                </div>
                            </a>
